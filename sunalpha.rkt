...
(define solarElevation (- 90.0 (solZenith geoLatitude declination hourAngle)))
...
(fprintf op2 " Zenith               ~a°~n" (fixed4 (solZenith geoLatitude declination hourAngle)))
...
(fprintf op2 " Azimuth             ~a°~n" (fixed4 (Azimuth hourAngle geoLatitude (solZenith geoLatitude declination hourAngle) declination)))
